        ...
        return (
            <div>
                <form onSubmit={this.onSubmit} className="formSize">
                    ...
                    <input type="text" onChange={this.changedTimeSubmitted} className="form-group form-control"/>
                    <input type="text" onChange={this.state.timeSubmitted} value={this.state.timeSubmitted}
                    className="form-control form-group"/>

                    <label>Date Of Submission</label>
                    <div>
                        <DatePicker selected = {this.state.date} onChange={this.changedDate}
                        className="form-group form-control" />
                    </div>
                    <input type="submit" className="btn btn-outline-warning" value="Create Report"/>
